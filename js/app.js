...
const highlightMenu = () => {
    ...
    const homeMenu = document.querySelector('#inicio');
    const aboutMenu = document.querySelector('#nosotros');
    const projectMenu = document.querySelector('#projectos');
    const contactMenu = document.querySelector('#contacta');
